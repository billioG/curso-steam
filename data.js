    ...
    modules: [
        {
            ...
            cards: [
                ...
                { id: 3, type: 'content', title: 'IA generativa: la que crea contenido nuevo', content: 'El tipo de IA que más ha cambiado el aula en los últimos años es la IA generativa: genera texto, imágenes, audio o video nuevos a partir de una instrucción (prompt). El chat de esta misma plataforma usa este tipo de IA. Es distinta de la IA "clásica" que solo clasifica o predice un número.', extra: 'Cuando hablamos de "usar IA en clase" en esta ruta, casi siempre nos referimos a IA generativa: la que redacta, dibuja o resume por instrucción tuya.' },
                { id: 4, type: 'content', title: 'Cómo "piensa" un modelo de lenguaje', content: 'Un modelo de lenguaje genera texto palabra por palabra, eligiendo en cada paso la palabra más probable según todo lo que ha "leído" durante su entrenamiento y el contexto de tu conversación. No consulta una base de datos de verdades: construye una respuesta plausible. Por eso puede sonar muy segura de sí misma incluso cuando se equivoca.', extra: 'Recuerda esta idea en cada módulo de esta ruta: la IA es fluida, no necesariamente exacta. Fluidez no es lo mismo que verdad.' },
                { id: 5, type: 'content', title: 'Mitos comunes que conviene soltar', content: 'Mito 1: "La IA me va a reemplazar como docente" — la IA no conoce a tus estudiantes, su contexto, ni puede sostener una relación humana de confianza en el aula. Mito 2: "Todo lo que dice es cierto" — puede inventar datos con total seguridad. Mito 3: "Es solo para expertos en tecnología" — si sabes escribir una instrucción clara en español, ya sabes usarla.', extra: 'El miedo y la sobreconfianza son los dos extremos que más perjudican el buen uso de la IA en el aula. El punto medio —curiosidad con criterio— es el que trabajaremos en esta ruta.' },
                { id: 6, type: 'content', title: 'La IA en el contexto guatemalteco', content: 'En Guatemala, la brecha digital es real: no todos los docentes ni estudiantes tienen acceso constante a internet o datos móviles. La IA generativa gratuita (como el chat de esta plataforma) es una oportunidad para el docente que sí tiene acceso, pero no debe asumirse como algo disponible para todos los estudiantes por igual.', extra: 'Esta ruta se enfoca primero en ti como docente: cómo la IA te ayuda a preparar mejor tus clases, no en asumir que cada estudiante tendrá acceso a ella en casa.' },
                { id: 7, type: 'content', title: 'La IA no sustituye el vínculo pedagógico', content: 'Ningún modelo de IA conoce el nombre de tu estudiante que faltó tres días porque ayuda en el negocio familiar, ni por qué otro necesita que le expliques con un ejemplo distinto. Ese conocimiento situado —el corazón de la buena docencia— sigue siendo exclusivamente tuyo. La IA acelera tareas; tú sostienes la relación educativa.', extra: 'A lo largo de esta ruta verás una idea repetida: la IA prepara el borrador, tú aportas el criterio pedagógico y el conocimiento real de tu grupo.' },
                { id: 8, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Qué describe MEJOR cómo funciona un modelo de IA generativa como el chat de esta plataforma?', options: ['Consulta una base de datos de hechos verificados y responde con la verdad exacta', 'Predice la palabra o contenido más probable según patrones aprendidos de grandes cantidades de datos', 'Piensa y razona exactamente igual que un ser humano', 'Solo puede responder preguntas que ya fueron programadas exactamente por un desarrollador'], correct: 1, explanation: 'La IA generativa no "sabe" hechos como una enciclopedia: predice, palabra por palabra, el contenido más probable dado el contexto. Por eso puede sonar segura y a la vez estar equivocada — no consulta la verdad, calcula probabilidad.' },
                { id: 9, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'Un docente guatemalteco en una comunidad rural con acceso limitado a internet quiere empezar a usar IA. ¿Cuál es el enfoque más realista para esta ruta?', options: ['No tiene sentido aprender IA si sus estudiantes no tienen acceso a internet en casa', 'Usar la IA como herramienta de preparación docente (planificar, adaptar contenido), sin asumir que cada estudiante tendrá el mismo acceso', 'Exigir que todos los estudiantes compren un teléfono con internet para poder avanzar', 'Esperar a que el gobierno resuelva la brecha digital antes de aprender IA'], correct: 1, explanation: 'Esta ruta prioriza el uso docente de la IA como herramienta de preparación y planificación — algo que el docente puede aprovechar hoy sin depender del acceso de cada estudiante, mientras la brecha digital se cierra gradualmente en el país.' }
            ]
        },
        {
            id: 2,
            ...
            cards: [
                ...
                { id: 12, type: 'content', title: 'Ejemplo: prompt débil vs. prompt fuerte', content: 'Débil: "Dame ideas para enseñar fracciones." Fuerte: "Soy docente de 5to primaria en un centro rural de Guatemala. Dame 3 actividades para enseñar fracciones usando materiales que cualquier familia tenga en casa (piedras, hojas, tortillas), cada una de máximo 15 minutos." La segunda versión produce algo directamente aplicable.', extra: 'Nota cómo el prompt fuerte no es más largo por lujo: cada frase agregada reduce la probabilidad de que la IA invente algo inútil para tu contexto real.' },
                { id: 13, type: 'content', title: 'Iterar: la primera respuesta casi nunca es la final', content: 'Tratar a la IA como una conversación, no como una máquina de una sola pregunta, cambia todo. Si la primera respuesta es demasiado larga, dile "hazlo más corto". Si es muy avanzada, dile "adáptalo a un estudiante que apenas empieza a leer". La IA recuerda el contexto de tu conversación y ajusta.', extra: 'Piensa en la primera respuesta como un primer borrador de un colega junior: útil como punto de partida, pero que tú refinas con tu criterio.' },
                { id: 14, type: 'content', title: 'Dar un rol a la IA', content: 'Pedirle a la IA que "actúe como" alguien específico mejora mucho la calidad de la respuesta: "Actúa como un experto en pedagogía inclusiva" o "Actúa como un docente con 20 años de experiencia en escuelas rurales guatemaltecas" orienta el tono y el enfoque de lo que genera.', extra: 'Esta técnica funciona porque el modelo ajusta su vocabulario y sus ejemplos al "personaje" que le pediste representar, dentro de los límites de lo que aprendió durante su entrenamiento.' },
                { id: 15, type: 'content', title: 'Pedir un formato específico', content: 'Si necesitas una tabla, pide explícitamente "en formato de tabla". Si necesitas una rúbrica, pide "una rúbrica con 4 niveles de desempeño por criterio". Si necesitas algo corto para leer en voz alta, pide "máximo 100 palabras, en lenguaje sencillo". Cuanto más específico el formato, menos edición necesitas después.', extra: 'Esta es la diferencia entre recibir un párrafo que tienes que reorganizar tú mismo, y recibir algo casi listo para copiar a tu cuaderno de planificación.' },
                { id: 16, type: 'content', title: 'Práctica guiada: usa el chat de esta plataforma', content: 'Esta misma aplicación tiene un chat con IA integrado (el ícono de chat que ya conoces). Ábrelo ahora y escribe un prompt siguiendo los 4 elementos: contexto + tarea + formato + restricciones, sobre un tema que enseñarás esta semana. Observa qué tan cerca está la primera respuesta de algo que usarías tal cual.', extra: 'No hay respuesta incorrecta en esta práctica: el objetivo es que sientas la diferencia entre un prompt vago y uno bien construido con tus propias manos.' },
                { id: 17, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Cuál de los siguientes prompts está mejor construido para obtener una respuesta útil y aplicable?', options: ['"Dame ideas de ciencias"', '"Ayúdame con una clase"', '"Soy docente de 3er primaria en Guatemala. Dame 3 actividades de 10 minutos sobre el ciclo del agua usando materiales caseros, en formato de lista"', '"Explícame la inteligencia artificial"'], correct: 2, explanation: 'El tercer prompt incluye contexto (grado, país), tarea específica (3 actividades sobre el ciclo del agua), restricciones (10 minutos, materiales caseros) y formato (lista). Esa especificidad reduce la necesidad de reescribir la respuesta después.' },
                { id: 18, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'La primera respuesta que te da la IA resulta demasiado avanzada para tus estudiantes de primer grado. ¿Qué deberías hacer?', options: ['Descartar la IA por completo y no volver a intentarlo', 'Aceptar la respuesta tal cual, ya que la IA "sabe más" que el docente', 'Responder en la misma conversación pidiendo que adapte el contenido a un nivel más sencillo, ya que la IA recuerda el contexto', 'Empezar una conversación completamente nueva desde cero cada vez que algo no sale bien'], correct: 2, explanation: 'La IA funciona como una conversación continua: puedes pedir ajustes directamente ("hazlo más sencillo", "adáptalo a primer grado") sin perder el contexto ya construido. Iterar es más eficiente que empezar de cero o descartar la herramienta.' }
            ]
        },
        {
            id: 3,
            ...
            cards: [
                ...
                { id: 21, type: 'content', title: 'Generar preguntas de repaso y quizzes', content: 'Pide a la IA un banco de preguntas sobre un tema ya enseñado, especificando cuántas preguntas, el tipo (opción múltiple, verdadero/falso, respuesta corta) y el nivel de dificultad. Esto ahorra tiempo real en la preparación de evaluaciones formativas rápidas, como un ticket de salida.', extra: 'Revisa siempre las preguntas generadas antes de usarlas: a veces la IA formula una pregunta ambigua o con más de una respuesta correcta sin darse cuenta.' },
                { id: 22, type: 'content', title: 'Ejemplos y analogías culturalmente relevantes', content: 'Puedes pedir explícitamente ejemplos anclados en la vida guatemalteca: "explica las fracciones usando el reparto de tortillas en una comida familiar" o "explica el concepto de ecosistema usando el lago de Atitlán". La IA puede generar analogías locales si se lo pides de forma directa — no lo hace por defecto.', extra: 'Esto es clave: la IA por defecto tiende a dar ejemplos genéricos o de otros países. Tú tienes que pedir explícitamente el contexto guatemalteco o local de tu comunidad.' },
                { id: 23, type: 'content', title: 'El límite más importante: tú validas siempre', content: 'La IA no conoce a Juanita, que aprende mejor con música, ni a Miguel, que necesita más tiempo para leer. Cualquier material generado por IA es un borrador que pasa por tu filtro pedagógico antes de llegar al aula: ¿es correcto?, ¿es apropiado para mi grupo?, ¿respeta el contexto de mis estudiantes?', extra: 'Piensa en la IA como un asistente que redacta rápido, pero que nunca ha estado en tu salón de clases. Ese conocimiento situado es insustituible y es tuyo.' },
                { id: 24, type: 'content', title: 'Verificar la información: las "alucinaciones"', content: 'La IA a veces "alucina": inventa datos, fechas, nombres o citas con total seguridad, sin señal de duda. Antes de usar un dato histórico, una cifra o una cita generada por IA en material oficial, verifícalo en una fuente confiable. Esto es especialmente importante en historia, ciencias y datos numéricos.', extra: 'Regla práctica: si el dato es memorable o "suena perfecto" para tu argumento, sospecha un poco más y verifica dos veces. Los datos demasiado convenientes son los que más vale la pena confirmar.' },
                { id: 25, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'Un docente en una escuela multigrado necesita explicar el mismo tema a estudiantes de 2do y 6to primaria en la misma sesión. ¿Cómo puede ayudar la IA aquí?', options: ['No puede ayudar porque la IA solo genera un tipo de explicación por tema', 'Generando dos versiones distintas del mismo contenido, adaptadas a cada nivel, pidiéndolo explícitamente en la conversación', 'Reemplazando por completo la necesidad de planificar clases diferenciadas', 'Solo sirve para estudiantes de grados avanzados'], correct: 1, explanation: 'La IA puede generar múltiples versiones adaptadas de un mismo contenido si se lo pides explícitamente para cada nivel — una ventaja real en el contexto de escuelas multigrado, muy común en el área rural de Guatemala.' },
                { id: 26, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Qué significa que una IA "alucine" un dato?', options: ['Que el sistema tiene una falla técnica y deja de funcionar', 'Que genera información falsa o inventada, pero la presenta con total seguridad como si fuera cierta', 'Que el docente hizo una pregunta incorrecta', 'Que la IA se niega a responder la pregunta'], correct: 1, explanation: 'Una "alucinación" ocurre cuando la IA genera información incorrecta o inventada —una fecha, un dato, una cita— pero la presenta con la misma confianza que un dato verificado. Por eso siempre hay que confirmar la información importante en una fuente confiable.' }
            ]
        },
        {
            id: 4,
            ...
            cards: [
                ...
                { id: 29, type: 'content', title: 'La IA no sustituye el juicio pedagógico', content: 'Ninguna herramienta de IA puede decidir si un estudiante está listo para avanzar de nivel, si una situación en el aula requiere atención socioemocional, o si un contenido es culturalmente apropiado para tu comunidad. Esas son decisiones profesionales que requieren juicio humano, ético y contextual — exactamente lo que tu formación docente te da.', extra: 'La IA acelera la parte mecánica del trabajo (redactar, organizar, generar borradores). Las decisiones que importan de verdad siguen siendo tuyas.' },
                { id: 30, type: 'content', title: 'Uso responsable y transparente', content: 'Si usas IA para generar parte de un material oficial (un informe, una planificación institucional, un documento para el MINEDUC), es buena práctica ser transparente al respecto con tus colegas y autoridades, igual que citarías cualquier otra fuente. La transparencia genera confianza en el uso de estas herramientas dentro de tu institución.', extra: 'Esta misma cultura de transparencia es la que le pedirás a tus estudiantes en el módulo de Ciudadanía Digital de esta ruta.' },
                { id: 31, type: 'content', title: 'Equidad de acceso en el aula', content: 'Si decides usar IA como parte de una actividad con estudiantes (no solo como preparación docente), recuerda que no todos tendrán el mismo acceso a internet o dispositivos en casa. Diseña las actividades para que el uso de IA ocurra en el aula, con supervisión, o como demostración del docente, en vez de asumir acceso individual garantizado.', extra: 'Esta es la misma lógica de equidad que ya aplicas al asignar tareas: siempre pensando en el estudiante con menos recursos, no en el promedio.' },
                { id: 32, type: 'content', title: 'Construyendo tu propio criterio', content: 'Al terminar esta ruta, la meta no es que sigas una lista de reglas rígidas, sino que desarrolles un criterio propio: cuándo la IA te ahorra tiempo valioso, cuándo su respuesta necesita verificación, y cuándo el trabajo simplemente requiere tu experiencia humana insustituible. Ese criterio se afina con la práctica, no con la teoría.', extra: 'Los siguientes cursos de esta ruta profundizan en aplicaciones concretas: ahorro de tiempo, herramientas específicas, inclusión y ciudadanía digital con tus estudiantes.' },
                { id: 33, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Cuál de las siguientes acciones representa un riesgo de privacidad al usar IA?', options: ['Pedir a la IA una actividad genérica sobre fracciones', 'Escribir en el chat: "Juan Pérez, del 4to B, tiene esta calificación en matemáticas: 45. Ayúdame a redactar una nota para sus padres explicando sus dificultades"', 'Pedir a la IA que explique un concepto de ciencias de forma sencilla', 'Solicitar una rúbrica genérica de evaluación'], correct: 1, explanation: 'Compartir el nombre completo de un estudiante junto con datos sensibles como calificaciones específicas expone información privada de un menor de edad en una herramienta externa. La forma correcta es describir la situación de manera general, sin identificar a la persona.' },
                { id: 34, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'Un docente planea usar IA como parte de una actividad directa con sus estudiantes en un centro rural con acceso desigual a internet. ¿Cuál es la decisión más equitativa?', options: ['Asumir que todos los estudiantes pueden usar IA en casa para la tarea', 'Realizar la actividad de IA en el aula, con supervisión del docente, en vez de asignarla como tarea individual en casa', 'Cancelar cualquier posibilidad de usar IA con estudiantes', 'Solo permitir que los estudiantes con teléfono propio participen'], correct: 1, explanation: 'Cuando el acceso a internet o dispositivos no es garantizado para todos, la opción más equitativa es que el uso de IA con estudiantes ocurra en el aula bajo supervisión docente, evitando que la brecha digital se traduzca en una brecha de aprendizaje.' },
                { id: 35, type: 'quiz', title: '✅ Repaso final del módulo', question: 'En esta ruta, ¿cuál es la idea central que debe guiar el uso de la IA en la práctica docente?', options: ['La IA siempre tiene razón y debe usarse sin revisión', 'La IA es una herramienta de apoyo que acelera tareas mecánicas, pero el criterio pedagógico, la verificación de datos y las decisiones sobre estudiantes siguen siendo responsabilidad humana del docente', 'La IA debe evitarse por completo en el contexto educativo guatemalteco', 'La IA reemplaza la necesidad de planificar clases'], correct: 1, explanation: 'El hilo conductor de todo este curso es el equilibrio: aprovechar la velocidad y versatilidad de la IA para tareas de preparación y borrador, mientras el juicio pedagógico, la verificación y las decisiones sobre estudiantes reales permanecen firmemente en manos del docente.' }
            ]
        }
    ]
},
    ...
    modules: [
        {
            ...
            cards: [
                ...
                { id: 3, type: 'content', title: 'Dónde SÍ y dónde NO debe entrar la IA', content: 'La IA es excelente generando un primer borrador rápido: una planificación base, un banco de preguntas, un correo. NO debe decidir la calificación final de un estudiante, ni sustituir tu conversación directa sobre el progreso de alguien. La regla de esta ruta: la IA redacta el borrador, tú decides con criterio.', extra: 'Esta distinción —borrador vs. decisión— es la que evita que "ahorrar tiempo" se convierta en "perder calidad pedagógica".' },
                { id: 4, type: 'content', title: 'La mentalidad correcta: asistente, no reemplazo', content: 'Piensa en la IA como un asistente junior muy rápido pero sin experiencia en tu aula: puede escribir un primer borrador de casi cualquier cosa en segundos, pero tú sigues siendo quien revisa, corrige y decide qué se queda. Esta mentalidad —"borrador rápido + revisión humana"— es la que aplicarás en cada módulo siguiente.', extra: 'Con esta mentalidad, cada tarea de este curso sigue el mismo patrón: pides el borrador a la IA, lo revisas en 2-3 minutos, lo ajustas y lo usas. El ahorro está en no partir de una página en blanco.' },
                { id: 5, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Cuál es la mentalidad correcta que propone este curso para usar la IA y ahorrar tiempo sin perder calidad?', options: ['Dejar que la IA decida las calificaciones finales de los estudiantes', 'Usar la IA para generar borradores rápidos que el docente revisa y ajusta antes de usarlos', 'Evitar la IA por completo para no perder el control pedagógico', 'Usar únicamente lo que la IA genera, sin ninguna revisión'], correct: 1, explanation: 'El patrón central de este curso es "borrador rápido + revisión humana": la IA acelera la parte mecánica de redactar un primer borrador, mientras el docente conserva el control sobre calificaciones, decisiones pedagógicas y ajustes finales.' }
            ]
        },
        {
            id: 2,
            ...
            cards: [
                ...
                { id: 8, type: 'content', title: 'Crear una rúbrica de evaluación en minutos', content: 'Pide a la IA una rúbrica con criterios y niveles de desempeño para una actividad específica: "Genera una rúbrica de 4 criterios y 3 niveles de desempeño para evaluar un proyecto de exposición oral de 5to primaria." El resultado es un punto de partida que ajustas a tus propios estándares.', extra: 'Una rúbrica clara compartida ANTES de la actividad no solo te ahorra tiempo calificando después: mejora directamente el desempeño de tus estudiantes, que saben qué se espera de ellos.' },
                { id: 9, type: 'content', title: 'Generar actividades de refuerzo rápido', content: 'Cuando detectas que un grupo necesita repasar un tema, pide a la IA 2-3 actividades cortas y variadas de refuerzo sobre ese tema puntual, en vez de reutilizar siempre el mismo ejercicio. Esto diversifica tu banco de recursos sin el costo de tiempo de diseñar cada actividad desde cero.', extra: 'Guarda las mejores actividades generadas en un documento propio: con el tiempo construyes tu propio banco personal de recursos, curado por ti.' },
                { id: 10, type: 'content', title: 'Práctica: tu plan de 5 minutos', content: 'Abre el chat de esta plataforma y pide un plan de clase completo para tu próxima lección, especificando grado, tema y duración. Cronometra cuánto tiempo te toma desde que escribes el prompt hasta que tienes un borrador utilizable. Compáralo con el tiempo que normalmente inviertes en planificar desde cero.', extra: 'Esta comparación directa es la mejor manera de convencerte —o no— del valor real de esta herramienta para tu rutina específica.' },
                { id: 11, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'Un docente que enseña la misma materia en 3ro y 5to primaria ya tiene una planificación completa para 5to. ¿Cómo puede ahorrar tiempo con IA para la clase de 3ro?', options: ['Debe escribir una planificación completamente nueva desde cero para 3ro', 'Puede pedirle a la IA que adapte la planificación existente de 5to, simplificando vocabulario y actividades para 3ro', 'No es posible reutilizar planificaciones entre grados diferentes', 'Debe usar exactamente la misma planificación sin ningún cambio'], correct: 1, explanation: 'Pedir a la IA que adapte un material ya existente a otro nivel es mucho más rápido que partir de cero, y aprovecha el trabajo de calidad que el docente ya invirtió en la planificación original.' }
            ]
        },
        {
            id: 3,
            ...
            cards: [
                ...
                { id: 14, type: 'content', title: 'La línea que la IA no debe cruzar', content: 'La IA puede ayudarte a redactar comentarios más rápido, pero la decisión de qué calificación merece un trabajo específico —con toda la información de contexto que tú tienes sobre ese estudiante— es exclusivamente tuya. Nunca subas el trabajo completo de un estudiante pidiendo "califícalo tú" sin tu revisión final.', extra: 'Esta es la aplicación directa, en calificación, del principio ético del primer curso de esta ruta: la IA redacta, el docente decide.' },
                { id: 15, type: 'content', title: 'Generar exámenes con niveles de dificultad variados', content: 'Pide a la IA un examen con preguntas organizadas por nivel de dificultad (básico, intermedio, avanzado) sobre un tema ya enseñado. Esto facilita crear evaluaciones diferenciadas para un grupo heterogéneo sin multiplicar tu tiempo de preparación por cada nivel.', extra: 'Revisa siempre las preguntas generadas: verifica que la respuesta "correcta" marcada sea efectivamente la única correcta, un error común en preguntas generadas rápidamente.' },
                { id: 16, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Cuál es la forma correcta de usar la IA en el proceso de calificación, según este curso?', options: ['Subir el trabajo completo del estudiante y pedirle a la IA que asigne la calificación final', 'Usar la IA para generar bancos de frases de retroalimentación y ejercicios de refuerzo, mientras el docente conserva la decisión final sobre la calificación', 'No usar la IA en ningún momento del proceso de calificación', 'Dejar que la IA califique solo los exámenes de opción múltiple, sin revisión'], correct: 1, explanation: 'La IA puede acelerar tareas como redactar retroalimentación variada o generar ejercicios de refuerzo, pero la calificación final —que requiere conocer el contexto completo del estudiante— sigue siendo una decisión exclusivamente del docente.' }
            ]
        },
        {
            id: 4,
            ...
            cards: [
                ...
                { id: 19, type: 'content', title: 'Organizar ideas dispersas en un documento estructurado', content: 'Si tienes notas sueltas, ideas escritas a mano o pensamientos desordenados sobre un proyecto o informe, puedes pegarlos en el chat y pedir a la IA que los organice en un documento estructurado con secciones claras. Esto es especialmente útil para informes institucionales o propuestas de proyecto.', extra: 'Esta técnica convierte 20 minutos de "no sé por dónde empezar a redactar esto" en 2 minutos de generar una estructura de partida.' },
                { id: 20, type: 'content', title: 'Plantilla de rutina semanal: qué automatizar y qué no', content: 'Al cierre de este curso, construye tu propia lista personal: qué tareas de tu semana vas a empezar a pedir como borrador a la IA (planificaciones, correos, bancos de preguntas) y cuáles vas a mantener 100% manuales porque requieren tu criterio directo y conocimiento único de tus estudiantes (calificaciones finales, conversaciones sensibles, decisiones disciplinarias).', extra: 'Esta lista es personal e irá cambiando con la práctica. Lo importante es que la decisión sea consciente, no por default.' },
                { id: 21, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'Un docente recibe un documento largo con una nueva política institucional y necesita decidir rápido si aplica a su caso. ¿Cuál es el mejor uso de la IA en esta situación?', options: ['Ignorar el documento porque es demasiado largo para leerlo', 'Pedir a la IA un resumen de los puntos clave para decidir si necesita leer el documento completo antes de actuar', 'Actuar directamente según el resumen de la IA sin verificar el documento original en decisiones importantes', 'Reenviar el documento sin leerlo a otro colega'], correct: 1, explanation: 'Un resumen generado por IA es un excelente punto de partida para decidir la urgencia de un documento, pero en asuntos con implicaciones legales o administrativas importantes, siempre conviene verificar el texto original antes de tomar una decisión final.' },
                { id: 22, type: 'quiz', title: '✅ Repaso final del módulo', question: '¿Cuál es el criterio central para decidir qué tareas SÍ automatizar con IA y cuáles mantener completamente manuales?', options: ['Automatizar todo lo posible sin excepción, ya que siempre ahorra tiempo', 'Automatizar tareas mecánicas y de borrador (planificar, redactar, organizar), y mantener manuales las decisiones que requieren criterio directo sobre estudiantes específicos (calificaciones finales, conversaciones sensibles)', 'No automatizar nada para evitar cualquier riesgo', 'Automatizar solo la comunicación con padres de familia'], correct: 1, explanation: 'El criterio que atraviesa todo este curso es la distinción entre tareas mecánicas de borrador (donde la IA aporta velocidad real) y decisiones que requieren juicio humano directo sobre un estudiante o situación específica (donde la IA no debe sustituir al docente).' }
            ]
        }
    ]
},
    ...
    modules: [
        {
            ...
            cards: [
                ...
                { id: 3, type: 'content', title: 'Cómo elegir la herramienta correcta según la tarea', content: 'La pregunta clave antes de buscar una herramienta nueva es: "¿qué necesito generar?" Si necesitas redactar o explicar algo, usa una herramienta de texto (como el chat de esta plataforma). Si necesitas una imagen para ilustrar un tema, busca una herramienta de imagen. No necesitas diez herramientas distintas: con dos o tres bien elegidas cubres la mayoría de tus necesidades.', extra: 'La trampa común es acumular apps sin usarlas. Mejor domina bien 2-3 herramientas que instalar 10 que nunca abres.' },
                { id: 4, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'Un docente quiere crear una imagen para ilustrar el ciclo del agua en su cartel de clase. ¿Qué categoría de herramienta de IA necesita?', options: ['Una herramienta de voz (texto a audio)', 'Una herramienta de imagen (generación visual)', 'Una herramienta de organización de tablas', 'No existe ninguna herramienta gratuita para esto'], correct: 1, explanation: 'Cuando la necesidad es generar material visual —un dibujo, una ilustración, un cartel— la categoría correcta es una herramienta de IA de imagen, distinta de las herramientas de texto o voz.' }
            ]
        },
        {
            id: 2,
            ...
            cards: [
                ...
                { id: 7, type: 'content', title: 'Simplificar un texto complejo', content: 'Si tienes un texto de nivel avanzado (un artículo, un fragmento de un libro de texto oficial) que necesitas adaptar a un grado menor, pégalo y pide: "Simplifica este texto para un estudiante de 3er primaria, manteniendo la idea principal." La IA reduce la complejidad del vocabulario sin perder el contenido esencial.', extra: 'Esta técnica es especialmente valiosa en escuelas multigrado, donde un mismo material fuente necesita adaptarse a varios niveles simultáneamente.' },
                { id: 8, type: 'content', title: 'Adaptar a lenguaje sencillo o bilingüe', content: 'Puedes pedir a la IA que reescriba un texto en lenguaje muy sencillo para estudiantes que están aprendiendo español como segunda lengua, un contexto común en comunidades donde el idioma materno es maya. Especifica siempre esta necesidad en tu prompt para obtener un resultado realmente adaptado.', extra: 'La IA no reemplaza el conocimiento del idioma materno de tus estudiantes, pero puede ayudarte a preparar material en español más accesible como punto de partida.' },
                { id: 9, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'Un docente tiene un texto de nivel avanzado y necesita una versión más sencilla para un estudiante de primaria baja. ¿Cuál es el mejor prompt?', options: ['"Explícame qué es un texto"', '"Simplifica este texto para un estudiante de 2do primaria, manteniendo la idea principal" (pegando el texto original)', '"Dame un texto nuevo sobre cualquier tema"', '"Traduce este texto a otro idioma"'], correct: 1, explanation: 'Pegar el texto original y pedir explícitamente que se simplifique para un nivel específico, manteniendo la idea principal, es la forma correcta de usar la IA de texto para esta tarea de adaptación.' }
            ]
        },
        {
            id: 3,
            ...
            cards: [
                ...
                { id: 12, type: 'content', title: 'Cuidado con derechos de autor', content: 'Las imágenes generadas por IA generalmente pueden usarse en material educativo sin problema, pero revisa siempre los términos de uso de la herramienta específica que utilices, especialmente si el material se publicará ampliamente o se venderá. Para uso interno de aula, la mayoría de herramientas gratuitas lo permite sin restricción.', extra: 'Esta es una precaución simple: lee los términos de la herramienta una sola vez al empezar a usarla, no necesitas revisarlo cada vez que generas una imagen.' },
                { id: 13, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Qué necesitas para generar una imagen educativa con una herramienta de IA gratuita como Canva?', options: ['Saber usar programas de diseño profesional como Photoshop', 'Describir con palabras claras lo que necesitas visualmente, sin necesidad de habilidades de diseño previas', 'Pagar una suscripción premium obligatoriamente', 'Tener una computadora especializada en diseño gráfico'], correct: 1, explanation: 'Las herramientas modernas de IA para imagen permiten generar material visual a partir de una simple descripción en palabras, sin necesitar habilidades previas de diseño gráfico ni software especializado.' }
            ]
        },
        {
            id: 4,
            ...
            cards: [
                ...
                { id: 16, type: 'content', title: 'Un flujo de trabajo completo, de principio a fin', content: 'Ejemplo real combinando herramientas: (1) dictas por voz tus ideas dispersas sobre una clase nueva; (2) pegas el texto en el chat de IA y pides que lo organice en una planificación estructurada; (3) generas una imagen ilustrativa para el tema con una herramienta de imagen; (4) conviertes el resumen de la clase a audio para estudiantes con dificultad lectora. Todo el proceso puede tomar menos de 15 minutos.', extra: 'No necesitas hacer los cuatro pasos siempre — elige según la necesidad real de cada clase. La idea es que tengas el repertorio completo disponible cuando lo necesites.' },
                { id: 17, type: 'content', title: 'Cuidando tus datos móviles', content: 'Muchas de estas herramientas consumen datos de internet, especialmente al generar imágenes. Si tienes un plan de datos limitado, prioriza el uso de estas herramientas cuando tengas acceso a wifi, y reserva el chat de texto (que consume menos datos) para cuando dependas de datos móviles.', extra: 'Esta es una consideración práctica real para el contexto guatemalteco, donde muchos docentes dependen de paquetes de datos limitados fuera de la escuela.' },
                { id: 18, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'Un docente tiene un plan de datos móviles limitado y necesita usar herramientas de IA con cuidado. ¿Qué estrategia es más razonable?', options: ['Nunca usar ninguna herramienta de IA por el riesgo de gastar datos', 'Priorizar el uso de herramientas que consumen menos datos (como chat de texto) fuera del wifi, y reservar generación de imágenes para cuando tenga acceso a wifi', 'Usar todas las herramientas sin ninguna consideración sobre el consumo de datos', 'Comprar un plan de datos ilimitado obligatoriamente antes de aprender estas herramientas'], correct: 1, explanation: 'Ser estratégico sobre cuándo usar herramientas que consumen más datos (como generación de imágenes) versus las más ligeras (como chat de texto) permite aprovechar la IA sin generar un gasto excesivo en un contexto de recursos de datos limitados.' },
                { id: 19, type: 'quiz', title: '✅ Repaso final del módulo', question: '¿Cuál es la idea central de este curso sobre cómo abordar las herramientas de IA disponibles?', options: ['Es necesario dominar todas las herramientas de IA que existen en el mercado', 'Basta con elegir 2-3 herramientas bien entendidas según tus necesidades más frecuentes (texto, imagen o voz), en vez de acumular muchas sin usarlas', 'Solo las herramientas pagas ofrecen resultados de calidad para el aula', 'Las herramientas de IA no son útiles sin conocimientos técnicos avanzados'], correct: 1, explanation: 'El curso propone un enfoque práctico: identificar tu necesidad real (texto, imagen, voz u organización) y dominar bien 2-3 herramientas gratuitas específicas, en vez de dispersarte intentando usar muchas herramientas superficialmente.' }
            ]
        }
    ]
},
    ...
    modules: [
        {
            ...
            cards: [
                ...
                { id: 3, type: 'content', title: 'Casos concretos de aula', content: 'Estudiante con dificultad lectora: pide a la IA una versión del texto con oraciones más cortas y vocabulario simple. Estudiante avanzado que termina rápido: pide una actividad de extensión con mayor reto. Estudiante con dificultad de atención: pide instrucciones divididas en pasos muy claros y breves. Cada caso usa el mismo chat, con un prompt distinto.', extra: 'No necesitas un diagnóstico formal para adaptar contenido — observar que un estudiante necesita algo distinto ya es suficiente para pedir una versión adaptada.' },
                { id: 4, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'Una docente tiene un grupo con estudiantes de niveles de lectura muy distintos y quiere usar el mismo texto base para todos. ¿Cómo puede ayudar la IA?', options: ['La IA no puede ayudar porque cada estudiante necesita un texto completamente diferente escrito por el docente', 'Generando distintas versiones del mismo texto adaptadas a cada nivel de lectura, a partir de un solo texto base', 'Usando solo la versión más simple para todo el grupo', 'Usando solo la versión más avanzada para todo el grupo'], correct: 1, explanation: 'La IA puede generar rápidamente múltiples versiones adaptadas de un mismo texto base, permitiendo que todos los estudiantes trabajen sobre el mismo tema con el nivel de complejidad apropiado para cada uno — la esencia de la diferenciación pedagógica hecha viable con menos tiempo.' }
            ]
        },
        {
            id: 2,
            ...
            cards: [
                ...
                { id: 7, type: 'content', title: 'Describir imágenes para estudiantes con baja visión', content: 'Si usas material visual en clase, puedes pedir a la IA una descripción textual detallada de una imagen para que un estudiante con baja visión, o quien lea el material en voz alta para él, tenga acceso al mismo contenido que sus compañeros ven directamente.', extra: 'Esta práctica —describir siempre lo que hay en una imagen antes de continuar la clase— beneficia no solo a estudiantes con baja visión, sino a todo el grupo, reforzando la comprensión visual con palabras.' },
                { id: 8, type: 'content', title: 'Material multimodal generado rápido', content: 'Un mismo tema explicado en texto, imagen y audio (multimodal) llega a más estudiantes con estilos de aprendizaje distintos que un solo formato. Usando las herramientas de texto, imagen y voz vistas en esta ruta, puedes preparar las tres versiones de un mismo tema en una fracción del tiempo que tomaría manualmente.', extra: 'No necesitas hacerlo para cada clase — reserva este esfuerzo extra para los temas más difíciles o los que históricamente generan más dudas en tu grupo.' },
                { id: 9, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Cuál es la diferencia clave entre "simplificar" y "empobrecer" un contenido al usar IA para adaptar material?', options: ['No hay ninguna diferencia, son sinónimos', 'Simplificar reduce la complejidad del lenguaje manteniendo las ideas esenciales; empobrecer elimina contenido importante en el proceso — el docente debe verificar siempre cuál ocurrió', 'Simplificar solo aplica a matemáticas, empobrecer solo a lectura', 'La IA nunca simplifica correctamente, siempre empobrece el contenido'], correct: 1, explanation: 'Simplificar bien un texto reduce la complejidad del vocabulario y la estructura sin perder las ideas centrales. Empobrecerlo elimina contenido importante. Solo el docente, con su conocimiento del tema, puede verificar cuál de los dos ocurrió realmente en una adaptación generada por IA.' }
            ]
        },
        {
            id: 3,
            ...
            cards: [
                ...
                { id: 12, type: 'content', title: 'Actividades de apoyo personalizado', content: 'Para un estudiante que necesita refuerzo puntual en un tema específico, pide a la IA 2-3 ejercicios cortos y progresivos enfocados exactamente en esa dificultad, en vez de repetir el ejercicio general que no le funcionó la primera vez.', extra: 'Este tipo de apoyo personalizado, antes reservado a quien tenía tiempo para tutorías individuales extensas, se vuelve viable de preparar en minutos.' },
                { id: 13, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'Un docente quiere ofrecer opciones de dificultad sin etiquetar públicamente a los estudiantes por su nivel. ¿Cuál es la mejor estrategia?', options: ['Anunciar en voz alta qué estudiantes deben usar la versión "fácil"', 'Presentar las distintas versiones de la actividad como "opciones a elegir" en vez de "niveles asignados por el docente"', 'Usar una sola versión de la actividad para todo el grupo sin excepción', 'Separar físicamente a los estudiantes según su nivel académico frente a toda la clase'], correct: 1, explanation: 'Ofrecer las versiones diferenciadas como opciones que el estudiante elige, en vez de asignaciones públicas por nivel, preserva la dignidad y motivación de cada estudiante, evitando el estigma de ser etiquetado frente a sus compañeros.' }
            ]
        },
        {
            id: 4,
            ...
            cards: [
                ...
                { id: 16, type: 'content', title: 'Casos guatemaltecos de éxito con recursos limitados', content: 'Docentes en escuelas rurales guatemaltecas ya usan estrategias de diferenciación con materiales mínimos: piedras para conteo, historias orales adaptadas al idioma materno, agrupaciones flexibles. La IA no reemplaza esta creatividad pedagógica ya existente: puede ayudar a documentarla, replicarla y compartirla más rápido con otros docentes.', extra: 'La inclusión pedagógica en Guatemala tiene una tradición valiosa mucho antes de la IA — esta herramienta se suma a ese trabajo, no lo inicia desde cero.' },
                { id: 17, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'Según este curso, ¿cuál es el propósito principal de usar IA para la inclusión educativa en el contexto guatemalteco?', options: ['Asumir que todos los estudiantes tendrán acceso individual a herramientas de IA en casa', 'Ayudar al docente a preparar más rápido material diferenciado, liberando tiempo para la atención humana directa que realmente sostiene la inclusión', 'Reemplazar la necesidad de conocer a cada estudiante individualmente', 'Usar la IA solo en escuelas urbanas con buena conectividad'], correct: 1, explanation: 'El enfoque central de este curso es que la IA acelera la preparación docente de material inclusivo y diferenciado, liberando tiempo para la atención humana directa — el verdadero motor de la inclusión educativa — sin asumir que los estudiantes mismos tienen acceso garantizado a estas herramientas.' },
                { id: 18, type: 'quiz', title: '✅ Repaso final del módulo', question: '¿Qué relación propone este curso entre la IA y la tradición de creatividad pedagógica ya existente en las escuelas guatemaltecas con recursos limitados?', options: ['La IA reemplaza por completo esas estrategias tradicionales', 'La IA se suma a esa tradición existente, ayudando a documentarla, replicarla y compartirla más rápido entre docentes', 'Esas estrategias tradicionales ya no son necesarias con la llegada de la IA', 'La IA solo funciona en escuelas con recursos abundantes'], correct: 1, explanation: 'Este curso reconoce que la inclusión pedagógica en Guatemala tiene una tradición de creatividad con recursos limitados que precede a la IA. La herramienta se integra a ese trabajo existente como apoyo adicional, no lo sustituye ni lo inicia desde cero.' }
            ]
        }
    ]
},
    ...
    modules: [
        {
            ...
            cards: [
                ...
                { id: 3, type: 'content', title: 'Qué necesita saber un estudiante, según su edad', content: 'Un estudiante de primaria necesita entender ideas simples: "una IA no siempre dice la verdad" y "nunca compartas tu nombre completo o dirección con un chat". Un estudiante de nivel medio puede empezar a entender conceptos de integridad académica y verificación de fuentes con mayor profundidad. Ajusta la complejidad de este curso al nivel real de tus estudiantes.', extra: 'No necesitas enseñar los cuatro módulos de este curso de la misma forma a todos los grados — adapta la profundidad, no la importancia del tema.' },
                { id: 4, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Cuál es el argumento principal de este curso a favor de enseñar sobre IA en vez de simplemente prohibirla en el aula?', options: ['Prohibir la IA es la única estrategia efectiva y debe aplicarse siempre', 'Los estudiantes ya la usan fuera del aula de todas formas; enseñar criterio de uso responsable es una habilidad más útil y realista que una prohibición difícil de hacer cumplir', 'La IA nunca debe mencionarse en el aula por ningún motivo', 'Solo los estudiantes de nivel avanzado deberían aprender sobre IA'], correct: 1, explanation: 'Dado que muchos estudiantes ya interactúan con IA fuera del aula sin ninguna guía, este curso argumenta que enseñar explícitamente el criterio de uso responsable es más efectivo y realista que una prohibición que es difícil de hacer cumplir y no prepara al estudiante para el resto de su vida.' }
            ]
        },
        {
            id: 2,
            ...
            cards: [
                ...
                { id: 7, type: 'content', title: 'Actividad de aula: IA vs. fuente confiable', content: 'Organiza una actividad donde los estudiantes, en parejas, le hacen la misma pregunta a una IA y luego buscan la respuesta en una fuente confiable (libro de texto, enciclopedia, sitio oficial). Comparan ambas respuestas y discuten las diferencias en grupo. Esta actividad convierte la verificación en un hábito practicado, no solo una regla mencionada una vez.', extra: 'Guarda los ejemplos más interesantes que surjan (casos donde la IA acertó y casos donde se equivocó) para reutilizarlos como ejemplo en futuras clases.' },
                { id: 8, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Cuál es una buena actividad de aula para enseñar a los estudiantes a verificar información generada por IA?', options: ['Prohibir que los estudiantes hagan cualquier pregunta a una IA', 'Pedir que hagan una pregunta a la IA sobre un tema que ya conocen y comparen la respuesta con una fuente confiable, discutiendo las diferencias', 'Aceptar sin cuestionamiento cualquier respuesta que dé una IA', 'Evitar mencionar el tema de la IA en el aula por completo'], correct: 1, explanation: 'Comparar activamente una respuesta de IA con una fuente confiable, sobre un tema que el estudiante ya conoce, convierte la verificación de información en un hábito practicado y vivencial, mucho más efectivo que simplemente advertir sobre el riesgo sin ejemplos concretos.' }
            ]
        },
        {
            id: 3,
            ...
            cards: [
                ...
                { id: 11, type: 'content', title: 'Una conversación de honestidad, no solo de prohibición', content: 'Más efectivo que una regla estricta es una conversación abierta con tus estudiantes sobre por qué la honestidad académica importa: no es solo evitar un castigo, es que el aprendizaje real ocurre cuando ELLOS piensan, no cuando copian una respuesta. Esta conversación construye motivación intrínseca, más duradera que el miedo a ser descubierto.', extra: 'Adapta esta conversación a la edad de tus estudiantes: con los más pequeños, puede ser tan simple como "aprender es como hacer ejercicio — si alguien más hace las flexiones por ti, tú no te fortaleces".' },
                { id: 12, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Cuál es un enfoque más efectivo que solo prohibir el uso de IA para evitar copiar en evaluaciones?', options: ['Aumentar los castigos por copiar sin cambiar nada más', 'Rediseñar las evaluaciones para requerir conexión con el contexto específico del estudiante y sostener conversaciones sobre por qué la honestidad académica importa para su propio aprendizaje', 'Eliminar todas las evaluaciones escritas de forma permanente', 'No mencionar el tema y esperar que los estudiantes decidan solos'], correct: 1, explanation: 'Rediseñar evaluaciones para que requieran aplicación personal y contextual (difícil de resolver solo con una IA genérica), combinado con conversaciones honestas sobre por qué el aprendizaje propio importa, es más efectivo y duradero que solo aumentar prohibiciones o castigos.' }
            ]
        },
        {
            id: 4,
            ...
            cards: [
                ...
                { id: 15, type: 'content', title: 'Equilibrio: la IA no sustituye pensar por uno mismo', content: 'El mensaje final para tus estudiantes: la IA puede ser un apoyo útil para organizar ideas, practicar o revisar, pero el pensamiento propio —resolver un problema, formar una opinión, crear algo original— es una capacidad que se fortalece usándola, no delegándola completamente a una herramienta externa.', extra: 'Esta idea cierra el círculo con el primer curso de esta ruta: así como tú, como docente, mantienes tu criterio pedagógico sobre la IA, tus estudiantes necesitan aprender a mantener el suyo.' },
                { id: 16, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Cuál es una regla básica de seguridad digital que debes enseñar explícitamente a tus estudiantes sobre el uso de chats de IA?', options: ['Es seguro compartir cualquier información personal con una IA porque es privada', 'Nunca compartir nombre completo, dirección, teléfono ni fotos propias en un chat de IA, igual que en cualquier otra plataforma en línea', 'Solo se debe tener cuidado con esta regla si el estudiante tiene más de 15 años', 'Los chats de IA son completamente diferentes a las redes sociales en términos de privacidad'], correct: 1, explanation: 'La regla de no compartir información personal identificable aplica a los chats de IA con la misma importancia que a cualquier otra plataforma digital, y debe enseñarse explícitamente y reforzarse con el tiempo, sin asumir que los estudiantes la conocen por sí solos.' },
                { id: 17, type: 'quiz', title: '✅ Repaso final de la ruta', question: 'Al cerrar esta ruta completa sobre IA, ¿cuál es el hilo conductor que conecta los 5 cursos (fundamentos, ahorro de tiempo, herramientas, inclusión y ciudadanía digital)?', options: ['La IA debe usarse sin ningún límite ni supervisión en todos los contextos', 'La IA es una herramienta poderosa que acelera tareas mecánicas y amplía el acceso, pero el criterio humano —del docente y, con guía, del estudiante— sigue siendo insustituible en las decisiones que realmente importan', 'La IA debe evitarse completamente en el contexto educativo', 'Solo los docentes con formación técnica avanzada pueden usar estas herramientas'], correct: 1, explanation: 'El hilo conductor de toda la ruta es el equilibrio entre aprovechar el poder real de la IA (velocidad, accesibilidad, apoyo a la inclusión) y preservar el criterio humano —pedagógico en el docente, crítico en el estudiante— en las decisiones donde el juicio propio es insustituible.' }
            ]
        }
    ]
},
    ...
    modules: [
        {
            ...
            cards: [
                ...
                { id: 3, type: 'content', title: '"No puede" vs. "no quiere"', content: 'El psicólogo Ross Greene resume una idea que transforma el manejo de aula: "los niños se portan bien si pueden". Lo que muchas veces interpretamos como desobediencia deliberada ("no quiere portarse bien") es, en realidad, una habilidad que todavía no tiene desarrollada: regular la frustración, esperar su turno, manejar un "no" como respuesta. Tratar un "no puede" como un "no quiere" castiga al estudiante por una habilidad que aún no domina, en vez de enseñársela.', extra: 'Esta distinción no significa "no hay consecuencias". Significa que la consecuencia por sí sola no enseña la habilidad que falta — eso requiere trabajo adicional, que verás en los módulos siguientes.' },
                { id: 4, type: 'content', title: 'Tu propia regulación emocional primero', content: 'Cuando un estudiante escala (grita, desafía, agrede), tu sistema nervioso también se activa: el impulso es responder con más volumen, más autoridad, más tensión. Pero un adulto desregulado no puede ayudar a un estudiante a regularse — dos personas alteradas se alimentan mutuamente. La primera herramienta de manejo de conducta no es sobre el estudiante: es tu propia capacidad de respirar, bajar el tono y responder en vez de reaccionar.', extra: 'Practica esto: antes de responder a una conducta desafiante, toma un respiro consciente de 2 segundos. Ese segundo de pausa cambia el tono de todo lo que sigue.' },
                { id: 5, type: 'content', title: 'El contexto detrás de la conducta en Guatemala', content: 'En muchas comunidades guatemaltecas, los estudiantes cargan realidades que el aula no ve directamente: pobreza, violencia intrafamiliar, migración de uno o ambos padres, responsabilidades de cuidado de hermanos menores, o inseguridad en el trayecto a la escuela. Ninguna de estas realidades "justifica" agredir a un compañero, pero sí explica por qué la capacidad de regulación de un estudiante puede estar agotada antes de que empiece la clase.', extra: 'Conocer el contexto de tus estudiantes no es opcional en el manejo de conducta: es la información que te permite responder con la estrategia correcta en vez de adivinar.' },
                { id: 6, type: 'content', title: 'La conducta como forma de comunicación', content: 'Un estudiante que no tiene todavía las palabras o la confianza para decir "no entiendo esto y me da vergüenza" puede expresar esa misma frustración tirando el lápiz o insultando a un compañero. La conducta desafiante casi siempre está comunicando algo: "necesito ayuda", "necesito atención", "necesito un descanso", "necesito sentirme en control de algo". Tu trabajo detectivesco es descifrar qué mensaje hay detrás.', extra: 'Pregúntate: ¿qué necesita este estudiante que no está pidiendo con palabras? Esa pregunta, repetida con el tiempo, revela patrones muy claros por estudiante.' },
                { id: 7, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'Según la idea de Ross Greene "los niños se portan bien si pueden", ¿cómo debería interpretarse mejor una conducta desafiante recurrente?', options: ['Como una decisión deliberada del estudiante de desobedecer sin razón', 'Como una señal de que el estudiante aún no tiene desarrollada la habilidad necesaria para manejar esa situación específica, más que como falta de voluntad', 'Como un problema exclusivamente de crianza que no le corresponde atender al docente', 'Como algo que se resuelve únicamente aumentando el castigo'], correct: 1, explanation: 'Este enfoque, respaldado por investigación en psicología del desarrollo, propone que la conducta desafiante recurrente suele reflejar una habilidad de autorregulación, comunicación o manejo de frustración que el estudiante aún no domina, más que una elección deliberada de desobedecer.' },
                { id: 8, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: 'Un estudiante grita y desafía al docente frente a la clase. ¿Cuál es la primera acción recomendada por este curso, antes de cualquier consecuencia?', options: ['Responder inmediatamente con el mismo tono elevado para demostrar autoridad', 'El docente regula su propia respuesta emocional primero (respirar, bajar el tono), ya que un adulto desregulado no puede ayudar a un estudiante a regularse', 'Ignorar la situación por completo sin ninguna respuesta', 'Expulsar al estudiante del aula de inmediato sin ninguna conversación'], correct: 1, explanation: 'La autorregulación del docente es el primer paso porque dos personas alteradas se alimentan mutuamente en una escalada. Responder desde la calma —no desde la reacción— es lo que permite manejar la situación con eficacia real.' }
            ]
        },
        {
            id: 2,
            ...
            cards: [
                ...
                { id: 11, type: 'content', title: 'El reservorio de confianza', content: 'Antes de poner un límite firme, necesitas una relación que lo sostenga. Cada interacción positiva —un saludo genuino, notar un logro pequeño, preguntar cómo está un estudiante que sabes que tuvo una mañana difícil— deposita algo en lo que podemos llamar un "reservorio de confianza". Cuando llega el momento de poner un límite firme, ese reservorio es lo que hace que el estudiante lo reciba como cuidado, no como ataque.', extra: 'Con el estudiante que más te desafía, la inversión en relación positiva rinde más, no menos. Es precisamente ese estudiante quien más necesita sentir que el vínculo sostiene el límite.' },
                { id: 12, type: 'content', title: 'Detectar la escalada antes de la explosión', content: 'La mayoría de las conductas desafiantes fuertes no aparecen de la nada: hay señales previas —tensión en el cuerpo, respiración acelerada, silencio repentino, comentarios cada vez más cortantes— que anteceden el estallido. Aprender a reconocer estas señales tempranas en cada estudiante te da una ventana de minutos para intervenir con calma, antes de que la situación escale a algo mucho más difícil de manejar.', extra: 'Lleva un registro mental (o escrito) de cómo se ve la escalada en tus estudiantes más desafiantes. Con el tiempo, reconocerás el patrón antes que ellos mismos.' },
                { id: 13, type: 'content', title: 'El ambiente físico también previene', content: 'La disposición del aula influye en la conducta: dos estudiantes que chocan constantemente sentados juntos, una zona de tránsito estrecha que genera empujones, o un rincón sin supervisión visual son factores ambientales que aumentan el riesgo de conflicto. Pequeños ajustes —reorganizar asientos, despejar pasillos, ubicar tu posición para tener vista de toda el aula— previenen más conflictos de los que resuelven muchas conversaciones después del hecho.', extra: 'Haz un mapa mental de tu aula: ¿dónde ocurren la mayoría de los conflictos? Casi siempre hay un patrón físico detrás, no solo un patrón de personas.' },
                { id: 14, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Por qué las normas de aula construidas junto con los estudiantes tienden a respetarse más que las impuestas por el docente?', options: ['Porque son normas más permisivas y fáciles de cumplir', 'Porque el proceso de construirlas juntos genera un compromiso genuino con algo que los estudiantes ayudaron a crear, en vez de una regla externa impuesta', 'Porque los estudiantes las olvidan más rápido y por eso generan menos conflicto', 'No hay ninguna diferencia real entre ambos enfoques'], correct: 1, explanation: 'La investigación en gestión de aula muestra que la participación en la construcción de normas genera un sentido de pertenencia y compromiso que una norma impuesta desde afuera no logra, incluso cuando el contenido de la norma es similar.' },
                { id: 15, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Cuál es la ventaja principal de reconocer las señales tempranas de escalada en un estudiante (tensión corporal, silencio repentino, respiración acelerada)?', options: ['Permite anticipar el castigo antes de que ocurra la conducta', 'Da al docente una ventana de tiempo para intervenir con calma antes de que la situación escale a un conflicto más difícil de manejar', 'No tiene ninguna utilidad práctica real en el aula', 'Sirve únicamente para justificar la expulsión del estudiante'], correct: 1, explanation: 'Detectar señales tempranas permite una intervención preventiva y calmada —una pregunta, un momento de pausa, un cambio de actividad— en vez de reaccionar solo cuando la conducta ya escaló a su punto más difícil de contener.' }
            ]
        },
        {
            id: 3,
            ...
            cards: [
                ...
                { id: 18, type: 'content', title: 'Ofrecer opciones limitadas, no órdenes absolutas', content: 'Dar una orden absoluta ("siéntate ahora") a un estudiante ya desregulado suele generar más resistencia, porque elimina toda sensación de control. Ofrecer dos opciones limitadas y aceptables para ti ("¿prefieres sentarte aquí o tomar un minuto en la esquina de calma?") le devuelve al estudiante una sensación de control dentro de un límite que tú ya definiste. Ambas opciones te sirven; el estudiante solo elige el camino.', extra: 'Esta técnica funciona especialmente bien con estudiantes que desafían la autoridad directa — les da autonomía real, sin renunciar al límite necesario.' },
                { id: 19, type: 'content', title: 'Cuándo ignorar y cuándo intervenir', content: 'No toda conducta necesita una respuesta inmediata y visible. Una interrupción menor para buscar atención (un comentario fuera de lugar, un gesto exagerado) muchas veces se apaga sola si no recibe la atención que busca — a esto se le llama extinción. Pero una conducta que pone en riesgo la seguridad de alguien (agresión física, amenazas) siempre requiere intervención directa e inmediata. Distinguir entre ambos casos evita gastar energía en batallas innecesarias y reservarla para lo que realmente importa.', extra: 'Pregúntate antes de reaccionar: "¿esta conducta pone en riesgo a alguien, o solo busca mi atención?" La respuesta determina si intervienes ahora o esperas un momento más oportuno.' },
                { id: 20, type: 'content', title: 'Evitar el espectáculo público', content: 'Confrontar a un estudiante frente a toda la clase casi siempre empeora la situación: activa su necesidad de "salvar la cara" frente a sus compañeros, y lo que era manejable se convierte en una batalla de orgullo. Siempre que sea posible, acércate en voz baja, habla en un tono que solo el estudiante escuche, o pide continuar la conversación en un momento y espacio más privado. El límite se mantiene; el impacto en la relación es muy distinto.', extra: 'Una frase corta y discreta en el pasillo, dicha con calma, suele lograr más que una corrección fuerte frente a treinta compañeros.' },
                { id: 21, type: 'content', title: 'El tiempo fuera bien usado', content: 'Un "tiempo fuera" no debe ser un castigo humillante ni una expulsión disfrazada: es un espacio breve para que el estudiante recupere su regulación, lejos del estímulo que lo desbordó. Preséntalo como una herramienta de autocuidado ("puedes ir al rincón de calma cuando lo necesites"), no como un destierro forzado frente a la clase. Cuando el estudiante puede pedirlo por sí mismo, ya está aprendiendo la habilidad de autorregulación que este curso busca desarrollar.', extra: 'Un "rincón de calma" con algo simple —una silla, un cojín, dibujos— comunica "aquí te puedes recomponer", muy distinto de una silla de castigo frente a toda la clase.' },
                { id: 22, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Qué es la "co-regulación" en el manejo de conducta desafiante?', options: ['Pedir a otro estudiante que ayude a controlar al que está desregulado', 'El proceso por el cual la calma del adulto (tono de voz, postura, respiración) ayuda al sistema nervioso del estudiante a bajar de intensidad, antes de cualquier conversación o consecuencia', 'Una técnica que solo funciona con estudiantes de primaria, no con adolescentes', 'Ignorar completamente al estudiante hasta que se calme solo'], correct: 1, explanation: 'La co-regulación se basa en que un estudiante desregulado no puede razonar en ese momento; necesita primero la calma prestada de un adulto cercano para bajar su nivel de activación, antes de poder procesar cualquier conversación o consecuencia.' },
                { id: 23, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Por qué ofrecer "opciones limitadas" (por ejemplo, dos alternativas aceptables para el docente) suele funcionar mejor que dar una orden absoluta a un estudiante desregulado?', options: ['Porque elimina por completo la necesidad de poner límites', 'Porque devuelve al estudiante una sensación de control dentro de un límite ya definido por el docente, reduciendo la resistencia que genera una orden absoluta', 'Porque es una forma de evitar tener que poner cualquier límite real', 'Porque los estudiantes siempre eligen la opción más fácil para el docente'], correct: 1, explanation: 'Las opciones limitadas mantienen el límite (ambas opciones son aceptables para el docente) mientras devuelven al estudiante una sensación de autonomía, lo cual reduce la resistencia típica ante una orden absoluta que no deja ningún espacio de decisión.' }
            ]
        },
        {
            id: 4,
            ...
            cards: [
                ...
                { id: 26, type: 'content', title: 'Refuerzo positivo genuino', content: 'Reconocer conducta positiva específica —no solo un "muy bien" genérico, sino "noté que respiraste hondo en vez de gritar cuando te frustraste, eso fue un gran paso"— fortalece exactamente la habilidad de autorregulación que quieres que el estudiante desarrolle. El refuerzo positivo genuino no es sobornar con premios materiales constantes: es nombrar en voz alta el progreso real, para que el estudiante también lo note en sí mismo.', extra: 'Los estudiantes que más desafían suelen recibir 10 correcciones por cada reconocimiento positivo. Invertir esa proporción, aunque sea gradualmente, cambia la relación completa con ese estudiante.' },
                { id: 27, type: 'content', title: 'Trabajar con la familia sin culpar', content: 'Cuando contactas a la familia sobre una conducta desafiante, el tono determina si se convierte en una alianza o en un conflicto adicional. Empezar con algo positivo sobre el estudiante, describir la conducta específica sin etiquetas ("gritó y empujó a un compañero" en vez de "es un niño problema"), y preguntar "¿cómo podemos apoyarlo juntos?" en vez de "¿qué está pasando en casa?" (que suena a acusación) construye una relación de equipo en vez de una de juicio.', extra: 'Muchas familias guatemaltecas ya cargan su propio estrés y desconfianza hacia la escuela. Un primer contacto que se siente como ataque cierra la puerta a cualquier colaboración futura.' },
                { id: 28, type: 'content', title: 'Reconocer los límites de tu rol', content: 'Hay conductas que superan lo que un docente, sin formación clínica, puede o debe manejar solo: señales de trauma severo, autolesión, agresión persistente y grave, o indicios de abuso en casa. Reconocer cuándo derivar a un orientador, psicólogo escolar o autoridad competente no es un fracaso — es parte responsable de tu rol. Ningún docente está obligado a resolver solo lo que requiere apoyo especializado.', extra: 'Ten claro, desde antes de que ocurra una crisis, a quién derivas en tu institución. Esa claridad previa te ahorra minutos valiosos cuando de verdad los necesitas.' },
                { id: 29, type: 'content', title: 'Tu propio autocuidado como docente', content: 'Manejar conductas desafiantes de forma constante desgasta emocionalmente, incluso cuando lo haces bien. No puedes sostener la calma de otros si tu propio tanque está vacío. Identifica qué te ayuda a recargarte —una pausa real en el recreo, hablar con un colega de confianza, dejar el trabajo en la escuela al salir— y trátalo como parte necesaria de tu trabajo, no como un lujo opcional.', extra: 'Un docente agotado tiene menos capacidad de co-regulación, menos paciencia y más probabilidad de reaccionar en vez de responder. Cuidarte a ti mismo es, literalmente, una herramienta de manejo de aula.' },
                { id: 30, type: 'quiz', title: '✅ Comprobemos lo aprendido', question: '¿Cuál es la diferencia clave entre una "consecuencia lógica" y un "castigo arbitrario"?', options: ['No hay ninguna diferencia real entre ambos términos', 'La consecuencia lógica está conectada directamente con la conducta específica (por ejemplo, ayudar a recoger lo que se tiró), mientras el castigo arbitrario no tiene relación directa y por eso enseña menos', 'El castigo arbitrario siempre es más efectivo a largo plazo', 'La consecuencia lógica solo aplica a estudiantes de los grados más altos'], correct: 1, explanation: 'Las consecuencias lógicas, al estar directamente relacionadas con la conducta, ayudan al estudiante a entender el impacto real de sus acciones y qué hacer distinto. Los castigos arbitrarios, al no tener esa conexión, generan más resentimiento que aprendizaje.' },
                { id: 31, type: 'quiz', title: '✅ Repaso final del curso', question: '¿Por qué reconocer los límites de tu rol docente (y derivar casos que requieren apoyo especializado) es parte responsable del manejo de conducta, y no un fracaso?', options: ['Porque un docente nunca debería involucrarse en absoluto con conductas difíciles', 'Porque hay situaciones —trauma severo, autolesión, indicios de abuso— que requieren formación clínica especializada que va más allá del rol docente, y derivarlas a tiempo protege tanto al estudiante como sostiene un manejo de aula responsable', 'Porque derivar un caso significa que el docente no sabe hacer su trabajo', 'Porque solo los psicólogos deberían tener contacto con estudiantes que presentan conductas desafiantes'], correct: 1, explanation: 'Un manejo de conducta responsable incluye reconocer cuándo una situación requiere apoyo especializado que va más allá de lo que un docente, sin formación clínica, puede manejar solo. Derivar a tiempo es una decisión profesional, no una falla.' }
            ]
        }
    ]
}
